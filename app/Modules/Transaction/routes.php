...
Route::middleware('auth:sanctum')->group(function (): void {
    ...
    Route::post('admin/payments', [PaymentController::class, 'store'])->middleware('permission:transaction_manage')->middleware('idempotent');
    ...
    Route::post('admin/receipts', [ReceiptController::class, 'store'])->middleware('permission:transaction_manage')->middleware('idempotent');
    ...
    Route::post('admin/journal-vouchers', [JournalVoucherController::class, 'store'])->middleware('permission:transaction_manage')->middleware('idempotent');
    ...
    Route::post('admin/fund-transfers', [FundTransferController::class, 'store'])->middleware('permission:transaction_manage')->middleware('idempotent');
